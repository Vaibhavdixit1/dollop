        ...
        <section className="bg-neutral-200 py-20 md:py-24 px-4 sm:px-6 lg:px-12 overflow-hidden border-y border-black/5">
            <div className="mx-auto max-w-7xl">
                ...
                <div ref={ref} className="relative">
                    {/* Fade edges */}
                    <div className="absolute left-0 top-0 bottom-0 w-16 md:w-24 bg-gradient-to-r from-neutral-200 to-transparent z-10 pointer-events-none"></div>
                    <div className="absolute right-0 top-0 bottom-0 w-16 md:w-24 bg-gradient-to-l from-neutral-200 to-transparent z-10 pointer-events-none"></div>
