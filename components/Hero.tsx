    ...
    return (
        <section className="relative flex flex-col items-center justify-center overflow-hidden bg-neutral-200 px-4 pt-32 pb-24 md:px-6 md:pt-40 md:pb-32 md:min-h-screen lg:px-12">
            ...
            <div className="relative z-10 mx-auto max-w-6xl text-center">
                <div className="mb-8 md:mb-10 inline-flex items-center rounded-full border border-black/5 bg-white/20 px-4 py-1.5 sm:px-6 sm:py-2 backdrop-blur-md">
                ...
                <h1 className="text-balance text-4xl font-black leading-[1.1] tracking-tighter text-neutral-900 sm:text-7xl md:text-9xl">
                    YOUR JOURNEY <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 to-neutral-900 uppercase">Starts Here.</span>
                </h1>

                <p className="mx-auto mt-8 md:mt-12 max-w-3xl text-balance text-lg font-medium leading-relaxed text-neutral-700 sm:text-2xl">
                ...
                <div className="mt-12 md:mt-20 w-full max-w-5xl rounded-[32px] md:rounded-[40px] border border-black/5 bg-white/70 p-3 md:p-4 backdrop-blur-3xl shadow-2xl">
