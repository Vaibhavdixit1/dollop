                ...
                >
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-4 md:gap-4">
                        <div className="group flex flex-col items-start px-6 py-4 md:px-8 md:py-6 text-left border-b md:border-b-0 md:border-r border-black/5 last:border-0 hover:bg-black/5 transition-all rounded-[24px] cursor-pointer">
                            ...
                            <span className="mt-1 text-base md:text-xl font-black text-neutral-900">THE OBJECTIVE</span>
                        </div>
                        <div className="group flex flex-col items-start px-6 py-4 md:px-8 md:py-6 text-left border-b md:border-b-0 md:border-r border-black/5 last:border-0 hover:bg-black/5 transition-all rounded-[24px] cursor-pointer">
                            ...
                            <span className="mt-1 text-base md:text-xl font-black text-neutral-900">TEMPORAL WINDOW</span>
                        </div>
                        <div className="group flex flex-col items-start px-6 py-4 md:px-8 md:py-6 text-left border-b md:border-b-0 md:border-r border-black/5 last:border-0 hover:bg-black/5 transition-all rounded-[24px] cursor-pointer">
                            ...
                            <span className="mt-1 text-base md:text-xl font-black text-neutral-900">THE PARTY</span>
                        </div>
